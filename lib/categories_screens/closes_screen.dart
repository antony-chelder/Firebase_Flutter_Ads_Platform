...
class ClosesScreen extends StatefulWidget {
  static const id = 'closes_id';

  @override
  _ClosesScreenState createState() => _ClosesScreenState();
}

class _ClosesScreenState extends State<ClosesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final clothes = myads.where('category', isEqualTo: 'CLoses').orderBy('time',descending: true).snapshots();
    return WillPopScope(
